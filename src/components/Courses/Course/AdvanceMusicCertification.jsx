...
import Image from "../../../assets/Courses/Course/Advance Music Certification.png";
...
function AdvanceMusicCertification() {
      ...
      <section className="course-container">
        <div className="course-container-left">
          <div className="course-container-left-heading-container">
            <div className="course-container-left-heading">
              <div className="course-container-breadcrumb">
                ...
                <img src={RightArrow} alt="Right Arrow" />
                <span>Advance Music Certification</span>
              </div>
              <h1>Advance Music Certification</h1>
            </div>
            <p>
              A comprehensive, 12-month course designed for both beginners and
              intermediate players ready to turn their passion into a
              profession.
            </p>
          </div>
          <img
            src={Image}
            alt="Advance Music Certification Image"
          ...
          <div className="course-container-left-info">
            ...
            <div className="course-container-left-info-text" id="overview">
              <h2>Overview</h2>
              <p>
                Work towards achieving the prestigious Trinity College London
                Grade 2-3 Certification which is a qualification respected
                globally.Master the Instruments and gain deep expertise across
                multiple musical disciplines, broadening your skill set and
                versatility.
              </p>
            </div>
        ...
        <div className="course-container-right">
          <div className="course-container-right-price">
            <p>
              Starts from <span>₹2,00,000</span>
            </p>
            <p>1 Year</p>
          </div>
          <hr />
...
export default AdvanceMusicCertification;
