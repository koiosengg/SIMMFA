...
import Image from "../../../assets/Courses/Course/GRMP.png";
        ...
        <div className="course-container-left">
          <div className="course-container-left-heading-container">
            <div className="course-container-left-heading">
              <div className="course-container-breadcrumb">
                ...
                <img src={RightArrow} alt="Right Arrow" />
                <span>Guaranteed Result Music Program</span>
              </div>
              <h1>Guaranteed Result Music Program (GRMP)</h1>
            </div>
            <p>
              These programs are designed for learners seeking structured
              training with measurable outcomes and certifications.
            </p>
          </div>
          <img
            src={Image}
          ...
          <div className="course-container-left-info">
            ...
            <div className="course-container-left-info-text" id="overview">
              <h2>Overview</h2>
              <p>
                The Guaranteed Result Music Program (GRMP) is a result-oriented
                course focused on performance excellence. Over 12 to 15 months,
                students learn 15 songs in any language and perform live twice
                on stage. If a learner fails to achieve results despite full
                attendance and effort, SIMMFA offers a 100% fee refund
                guarantee.
              </p>
            </div>
            ...
            <div className="course-container-left-info-text" id="requirements">
              ...
              <ul>
                <li>Open to all (no age limit).</li>
                <li>Must maintain 90% attendance and complete homework.</li>
                <li>Instrument required for home practice.</li>
              </ul>
            </div>

            <div className="course-container-left-info-text" id="duration">
              <h2>Duration</h2>
              <p>12-15 months ( 2 sessions per week x 1 hour each)</p>
            </div>
            ...
            <div className="course-container-left-outcomes" id="outcomes">
              ...
              <div className="course-container-left-outcomes-points">
                <div className="course-container-left-outcomes-point">
                  ...
                  <p>Perform 15 songs confidently on stage.</p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Master rhythm, timing, and expression.</p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Gain real-world performance experience. </p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Build strong technical and theoretical knowledge. </p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Develop the confidence to perform professionally.</p>
                </div>
              </div>
            </div>
            ...
            <div className="course-container-left-fees" id="fees">
              ...
              <p className="course-container-left-fees-para">
                Includes 2 Guaranteed live performances + 100% Refund Policy{" "}
              ...
              <div className="course-container-left-fees-category course-container-left-fees-category-1">
                <div className="course-container-left-fees-category-sidebar">
                  <div className="course-container-left-fees-category-sidebar-price">
                    <img src={BeginnerCategory1} alt="Annual Music Course" />
                    <h3>Annual Music Course</h3>
                    <p>
                      <span>₹60,000</span>
                    </p>
                  </div>
                ...
                <div className="course-container-left-fees-category-sidebar">
                  <div className="course-container-left-fees-category-sidebar-price">
                    <img src={IntermediateCategory1} alt="One-on One Course" />
