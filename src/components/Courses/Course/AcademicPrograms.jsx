...
import Image from "../../../assets/Courses/Course/Academic Programs.jpg";
...
import Clock from "../../../assets/Courses/Course/Clock.svg";
      ...
      <section className="course-container">
        <div className="course-container-left">
          <div className="course-container-left-heading-container">
            <div className="course-container-left-heading">
              ...
              <h1>
                Academic Programs{" "}
                <span>(Diploma , Degree , Post Graduate)</span>
              </h1>
            </div>
            <p>
              Full-time Diploma , Degree , Post Graduate Programs designed for
              learners pursuing a professional career in music, sound, and
              technology.
            </p>
          </div>
          <img
            src={Image}
            alt="Academic Programs Image"
          ...
          <div className="course-container-left-info">
            ...
            <div className="course-container-left-info-text" id="overview">
              <h2>Overview</h2>
              <p>
                These academic programs are designed for students pursuing a
                career in music, sound, or entertainment. Students learn up to 6
                instruments, specialize in one, and receive hands-on training in
                recording, live sound, and music production. The curriculum also
                includes foreign-language learning (French, Korean, Spanish,
                Arabic, Japanese) to prepare graduates for international
                opportunities.
              </p>
            </div>
            ...
            <div className="course-container-left-info-text" id="requirements">
              ...
              <ul>
                <li>
                  Must have completed higher secondary education (for
                  Diploma/Degree).
                </li>
                <li>Graduates may apply for Postgraduate (PG) programs.</li>
                <li>Full-time learning commitment required.</li>
              </ul>
            </div>
            ...
            <div className="course-container-left-outcomes" id="outcomes">
              ...
              <div className="course-container-left-outcomes-points">
                <div className="course-container-left-outcomes-point">
                  ...
                  <p>Master multiple instruments and production tools</p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Gain in-depth knowledge of sound design and editing.</p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Experience live and studio-based training.</p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>Build a professional career portfolio. </p>
                </div>
                <div className="course-container-left-outcomes-point">
                  <img src={RedCheck} alt="Red Check Icon" />
                  <p>
                    Become industry-ready for music, film, OTT, or gaming
                    sectors.
                  </p>
                </div>
              </div>
              ...
              <div className="course-container-left-fees-category course-container-left-fees-category-1">
                <div className="course-container-left-fees-category-sidebar">
                  <div className="course-container-left-fees-category-sidebar-price">
                    <img src={BeginnerCategory1} alt="Diploma" />
                    <h3>Diploma</h3>
                    <p>
                      <span>₹5,00,000</span>
                    </p>
                ...
                <div className="course-container-left-fees-category-sidebar">
                  <div className="course-container-left-fees-category-sidebar-price">
                    <img src={IntermediateCategory1} alt="Degree" />
                    <h3>Degree</h3>
                    <p>
                      <span>₹5,00,000</span>
                    </p>
                ...
                <div className="course-container-left-fees-category-sidebar">
                  <div className="course-container-left-fees-category-sidebar-price">
                    <img src={AdvancedCategory1} alt="Post Graduate" />
                    <h3>Post Graduate</h3>
                    <p>
                      <span>₹6,00,000</span>
                    </p>
        ...
        <div className="course-container-right">
          <div className="course-container-right-price">
            <p>
              Starts from <span>₹5,00,000</span>
            </p>
          </div>
          <hr />
