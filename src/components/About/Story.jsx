...
import Image from "../../assets/About/Story/Desktop Background.png";

function Story() {
  return (
    <section className="about-story">
      <div className="about-story-content">
        <div className="about-story-content-heading">
          <h2>10k+ Students created their success story with SIMMFA</h2>
          <p>
            At SIMMFA, we believe every learner deserves the right guidance to
            unlock their true potential. Over the years, more than 10,000
            students have transformed their passion into skill through our
            personalized training, expert mentors, and hands-on learning
            experience.
          </p>
        </div>
        <div className="about-story-content-text">
          <svg
            ...
            fill="none"
          >
            <path d="M56 0H0V56H56V0Z" fill="#CC3102" />
            <path
              opacity="0.2"
          ...
          <p>A Voice from the Community</p>
          <p>
            Before SIMMFA, music was just a hobby. Now it’s my identity. The
            support, guidance, and environment pushed me to become the best
            version of myself.
          </p>
        </div>
      </div>
